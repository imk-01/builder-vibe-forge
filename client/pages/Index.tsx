...
const mockActivities: Kegiatan[] = [
  {
    ...
    deskripsiKegiatan:
      "Survei untuk mengumpulkan data sosial ekonomi rumah tangga di seluruh Indonesia sebagai dasar perencanaan pembangunan nasional.",
  ...
  },
  {
    ...
    deskripsiKegiatan:
      "Sensus untuk mengumpulkan data komprehensif tentang struktur pertanian dan perkebunan di Indonesia.",
    status: "Persiapan",
  ...
  },
  {
    ...
    deskripsiKegiatan:
      "Survei ketenagakerjaan untuk mendapatkan data tentang kondisi ketenagakerjaan di Indonesia.",
...
const calculateActivityStatus = (
  ...
  const checkTahapanWarning = (
    ...
    if (
      tanggalSelesai &&
      isValid(parseISO(tanggalSelesai)) &&
      isPast(parseISO(tanggalSelesai))
    ) {
  ...
  if (
    kegiatan.tanggalSelesaiDiseminasiEvaluasi &&
    isValid(parseISO(kegiatan.tanggalSelesaiDiseminasiEvaluasi)) &&
    ...
    isValid(parseISO(kegiatan.tanggalMulaiDiseminasiEvaluasi)) &&
    ...
    isValid(parseISO(kegiatan.tanggalMulaiPengolahanAnalisis)) &&
    ...
    isValid(parseISO(kegiatan.tanggalMulaiPengumpulanData)) &&
    ...
    <div className="space-y-4">
      {pplList
        ...
        .map((ppl) => (
          <Card
            key={ppl.id}
            className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 hover:shadow-md transition-all"
          >
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-sm text-gray-600">
                    <p>
                      <span className="font-medium">PML:</span> {ppl.namaPML}
                    </p>
                    <p>
                      <span className="font-medium">Beban Kerja:</span>{" "}
                      {ppl.bebanKerja} {ppl.satuanBebanKerja}
                    </p>
                    <p>
                      <span className="font-medium">Honor:</span> Rp{" "}
                ...
                <div className="text-right">
                  <div className="flex items-center space-x-1">
                    ...
                    <div className="text-xl font-bold text-bps-blue-600">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Total Beban: {ppl.bebanKerja} {ppl.satuanBebanKerja}
                  </p>
                </div>
                <div className="text-right">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">
                Dashboard Monitoring PPL
              </h1>
              <p className="text-bps-blue-100 text-lg">
                Pantau progress dan kelola semua kegiatan secara real-time
              </p>
          ...
          {[
            {
              ...
              icon: Activity,
              color: "bps-blue",
              bgColor: "bg-bps-blue-50 border-bps-blue-200",
            },
            {
              label: "Persiapan",
              value: stats.persiapan,
              icon: BookOpen,
              color: "blue",
          ...
          {filteredActivities.length === 0 ? (
            ...
            filteredActivities.map((activity) => {
              ...
              return (
                <Card
                  key={activity.id}
                  className="bps-card-hover border border-gray-200 overflow-hidden"
                >
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <Badge
                        className={cn(
                          ...
                          warnings.length > 0 ? "status-badge-warning" : color,
                        )}
                      >
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="space-y-3">{getStageDates()}</div>

                    <div className="flex items-center justify-between text-xs text-gray-500 pt-2 border-t">
                      <div className="flex items-center space-x-1">
                        <Clock className="w-3 h-3" />
                        <span>
                          Update: {getRelativeTime(activity.lastUpdated)}
                        </span>
                      </div>
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-bps-blue-600">
                          {selectedActivity.progressKeseluruhan}%
                        </span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <Card className="p-4">
                    ...
                    <div className="space-y-3 text-sm">
                      {[
                        {
                          label: "Persiapan",
                          start: selectedActivity.tanggalMulaiPersiapan,
                          end: selectedActivity.tanggalSelesaiPersiapan,
                        },
                        {
                          label: "Pengumpulan Data",
                          start: selectedActivity.tanggalMulaiPengumpulanData,
                          end: selectedActivity.tanggalSelesaiPengumpulanData,
                        },
                        {
                          label: "Pengolahan & Analisis",
                          start:
                            selectedActivity.tanggalMulaiPengolahanAnalisis,
                          end: selectedActivity.tanggalSelesaiPengolahanAnalisis,
                        },
                        {
                          label: "Diseminasi & Evaluasi",
                          start:
                            selectedActivity.tanggalMulaiDiseminasiEvaluasi,
                          end: selectedActivity.tanggalSelesaiDiseminasiEvaluasi,
                        },
                      ].map((phase, index) => (
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
            ...
            <DialogFooter className="pt-4 border-t mt-4 flex-shrink-0">
              ...
              <Button
                ...
                className="bps-gradient text-white"
              >
                Simpan Progress
              </Button>
            </DialogFooter>
